...
public class IHProgressHUD : UIView {
    ...
    private var viewCornerRadius: CGFloat = 14.0//Miodified by - Shehroz
...
extension IHProgressHUD {
    ...
    //    Miodified by - Shehroz
//    public class func set(cornerRadius: CGFloat) {
//        sharedView.cornerRadius = cornerRadius
//    } // default is 14 pt

    public class func setViewCornerRadius(cornerRadius: CGFloat) {
        sharedView.viewCornerRadius = cornerRadius
    }
...
//        hudView?.layer.cornerRadius = cornerRadius
        hudView?.layer.cornerRadius = viewCornerRadius
